...
public class CnTaxCodeTest {
	...
	public void beforeEach() {
		jsonStr = "{\"created_at\":\"2014-11-18T04:22:47Z\",\"updated_at\":\"2014-11-18T04:22:47Z\",\"id\":\"79b86a51-5108-0132-6a09-600308937d74\",\"name\":\"CustomSalesTax\",\"description\":\"CustomStateTax\",\"sale_taxes\":[{\"id\":\"79b3af61-5108-0132-6a04-600308937d74\",\"name\":\"GST(sales)\",\"rate\":6.0}],\"purchase_taxes\":[{\"id\":\"79b5f951-5108-0132-6a07-600308937d74\",\"name\":\"GST(purchase)\",\"rate\":1.0}],\"sale_tax_rate\":6.0,\"purchase_tax_rate\":1.0}";
	...
	public void gsonCasting_itBuildsTheRightObject() {
		...
		Map<String,Object> firstSaleTax = ((List<Map<String, Object>>) hash.get("sale_taxes")).get(0);
		assertEquals(firstSaleTax.get("name"),subject.getSaleTaxes().get(0).getName());
		assertEquals(firstSaleTax.get("rate"),subject.getSaleTaxes().get(0).getRate());
