...
public class SsoServiceTest {
	private static final String SPECIAL_PRESET = "special";
	private static final String X509CERTIFICATE_VALUE = "X509CERTIFICATE_VALUE";
	private static final String X509FINGERPRINT_VALUE = "X509FINGERPRINT_VALUE";
	...
	@Test
	public void getX509Certificate_itReturnsTheRightSpecialConfigurationValue() {
		assertEquals(X509CERTIFICATE_VALUE, subject.getX509Certificate(SPECIAL_PRESET));
	}
	
	@Test
	public void getX509Fingerprint_itReturnsTheRightSpecialConfigurationValue() {
		assertEquals(X509FINGERPRINT_VALUE, subject.getX509Fingerprint(SPECIAL_PRESET));
	}
